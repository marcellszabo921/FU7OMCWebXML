...
public class JSONWriteFU7OMC {
    ...
    public static void main(String[] args) {
        try (FileReader reader = new FileReader("src/main/resources/orarendFU7OMC.json")){
            ...
            JSONObject root = (JSONObject) object.get("SZM_orarend");
            ...
            output.put("SZM_orarend", outputArr);

            try(FileWriter writer = new FileWriter("src/main/resources/orarendFU7OMC1.json")) {
